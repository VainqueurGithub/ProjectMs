@extends('layout.base', ['title' => 'Assurance - Editer Facture'])
@section('content')
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                            ...
                            <div class="row">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select class="form-control" name="Propriete" id="Produit">
                                        <option value="{{ $medicaments->id }}">{{$medicaments->code}} / {{$medicaments->prix}}</option>
                                    ...
                                    {!! $errors->first('Propriete', '<span class="error">:message</span>') !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Quantité" name="Quantite" value="{{$Commande->Qte}}" />
