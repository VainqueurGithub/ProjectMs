@extends('layout.base', ['title' => 'Assurance - Nouvelle Cotisation'])
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-default">
        <div class="card-header">
          <div class="row">
              <div class="col-md-3"> Ajout d'une Cotisation</div>
              ...
              <form role="form" method="POST" action="{{ route('Cotisations.store')}}">
                  {{ csrf_field() }}
                  @include('Cotisations._Form', ['ButtonSubmitTexe'=>'Enregistrer'])
