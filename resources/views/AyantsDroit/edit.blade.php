  ...
  <div class="content-wrapper">
    ...
    <div class="card card-default">
        <div class="card-header">
          <div class="row">
              <div class="col-md-3"> Edition d'une personne en charge</div>
              <div class="col-md-7"></div>
              <div class="col-md-2">
                   <a href="{{ route('Affiliers.show', $Affilier->id) }}" style="text-decoration: none;color: white">
                <div class="btn btn-info pull-right"  style="margin-top: -5px">
                 <i class="fa fa-book"></i> Retour
                </a>
              </div>
          </div>  
      </div> 
                          <form role="form" method="POST" action="{{ route('AyantsDroit.update',$AyantDroit)}}">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                              @include('AyantsDroit._Form', ['ButtonSubmitTexe'=>'Modifier'])
