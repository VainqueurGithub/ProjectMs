       ...
       <div class="row">
        ...
        <div class="col-md-6">
            <div class="modal-body">
              <form method="POST" action="{{route('dettachedAccount')}}" enctype="multipart/form-data" onsubmit='return confirm("Etez -vous sur de supprimer ce comptes pour le repportage ?")'>
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                  <div class="card-body">
                    <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                          @foreach($ComptePrincipal as $CompteP) 
                                               <tr>
                                                @if($CompteP->compte_principale_id==$CompteP->id AND $CompteP->compte_repport_id==$CompteR)
                      ...
                      <div class="col-md-6">
                        <div class="card-footer">
                          <button type="submit" class="btn btn-danger swalDefaultSuccess" onclick='return confirm("Etez -vous sur de supprimer ce comptes pour le repportage ?")'><i class="fas fa-save"></i> Valider L'action</button>
                        </div>
                      </div>
