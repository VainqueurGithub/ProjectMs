      ...
      <div class="container-fluid">
            <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                        <form method="POST" action="{{ route('AfficherBalance')}}">
                              {{ csrf_field() }}
                            <div class="row">
                              <div class="col-3"></div>
                                <div class="col-6">
                                    <div class="form-group">
                                       <label for="hue-demo">Type de Balance</label>
                              ...
                              <div class="col-3">
                                ...
                                <div class="card-body">
                                    <button type="submit" name="Afficher" class="btn btn-success">Afficher Résultat</button><br /><br />
                                    <button type="submit" name="Imprimer" class="btn btn-primary">Imprimer Résultat</button> <br /><br />
                                </div>
                               </div>
                              </div>
