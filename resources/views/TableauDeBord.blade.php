@extends('layout.base', ['title' => 'StockApps - Tableau De Bord'])
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-dark">TABLEAU DE BORD (suivie synthetique annuelle des activités du MS)</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    $.get('{{ route('ecart') }}',
          ...
          function(dt){
             ...
             Morris.Bar({
                ...
                xkey: 'y',
                ykeys: ['a', 'b','c'],
                labels: ['Cotisation', 'Consommation','Ecart'],
                hideHover: 'auto',
                resize: true
            });
